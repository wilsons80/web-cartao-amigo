...
@Component({
  selector: 'combo-pesquisavel-outline',
  templateUrl: './combo-pesquisavel-outline.component.html',
  styleUrls: ['./combo-pesquisavel-outline.component.css'],
  viewProviders: [{ provide: ControlContainer, useExisting: NgForm },
                  { provide: ControlContainer, useExisting: forwardRef(() => NgModelGroup) }],
  encapsulation: ViewEncapsulation.None
})

export class ComboPesquisavelOutlineComponent implements OnInit, OnChanges {
